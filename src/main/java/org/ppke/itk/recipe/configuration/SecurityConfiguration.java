...
import org.ppke.itk.recipe.security.CostumDetailsService;
...
/*
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests().anyRequest().permitAll().and().httpBasic(httpBasics->httpBasics.disable()).formLogin(formLogin->formLogin.disable());
